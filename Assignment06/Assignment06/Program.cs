...
namespace Assignment06
{
    internal class Program
    {
        ...
        static string conStr = "server=LAPTOP-P20IR6K6;database=ProductInventoryDb;trusted_connection=true;";
        ...
        static void RemoveProduct(SqlConnection con)
        {
            ...
            if (nor > 0)
            {
                Console.WriteLine("Product removed successfully from inventory!!");
            }
        }
    }
}